...
const PORTALS = [
  ...
  { id: 'officer', mark: 'officer', name: 'Health officer', who: 'PHC, block or district',
    does: 'See coverage as it happens, not a month later.',
    points: ['Village coverage and problem alerts', 'Add a programme from a PDF', 'Exports for every downstream system'] },
